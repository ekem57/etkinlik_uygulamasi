...
static  LatLng _initialcameraposition = LatLng(28.674851998976695, 28.674851998976695);
    ...
    location.onLocationChanged.listen((l) {
      _controller.animateCamera(
        CameraUpdate.newCameraPosition(
          CameraPosition(target: LatLng(10, 20),zoom: 20),
        ),
      );
    });
  }
  ...
  static final CameraPosition _kLake = CameraPosition(
      ...
      target: LatLng(28.674851998976695, 28.674851998976695),
