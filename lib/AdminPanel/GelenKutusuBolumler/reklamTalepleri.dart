...
import 'package:etkinlik_kafasi/AdminPanel/GelenKutusuBolumler/adminreklamIcerik.dart';
...
class AdminReklamTalepleri extends StatefulWidget {
  @override
  _AdminReklamTalepleriState createState() => _AdminReklamTalepleriState();
}

class _AdminReklamTalepleriState extends State<AdminReklamTalepleri> {
          ...
          child: ListView(
            children: [
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection('iletisim').doc("reklam").collection("reklamlar").orderBy('tarih',descending: true).snapshots(),
                    ...
                    itemBuilder: (_, int index) {
                     ...
                     DateTime _tarih = _card['tarih'].toDate();
                      ...
                      return Slidable(
                        ...
                        child: ResimliCard(textSubtitle: _card['mesaj'].toString(), textTitle: _card['gonderenIsim'].toString(),
                          fontSize: 20,
                          img: _card['gonderenFoto'].toString(),
                          tarih: zaman,
                          onPressed: (){

                            Navigator.of(context, rootNavigator: true).push(MaterialPageRoute(builder: (context) =>AdminReklamIcerik(card: _card,tarih: formatTheDate(_tarih, format: DateFormat("dd.MM.y")),)),);
                        ...
                        secondaryActions: <Widget>[
                          ...
                          Container(
                            ...
                            child: IconSlideAction(
                                ...
                                icon: Icons.delete,
                                onTap: () async {
                                  await _adminIslemleri.adminReklamlarSil(_card);
                                  setState(() {
